...
export const getDefaultTheme = () => ({
  colors: {
    ...
    elevation1: "$slateDark2", // bg color of the root panel (main title bar)
    elevation2: "$slateDark2", // bg color of the rows (main panel color)
    // elevation3: "#373c4b", // bg color of the inputs
    elevation3: slateDark.slate6, // bg color of the inputs
